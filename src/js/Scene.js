...
class Scene {
  ...
  async loadResources() {
    ...
    */
    ...
    this.videoTwitch = videoTwitch;
    // videoTwitch.setAttribute('crossorigin', 'anonymous');
    videoTwitch.loop = true;
  ...
  async buildScene() {
    ...
    const points = {
      ...
      // "Twitch" : {
      //   offset: new THREE.Vector3(0, -0.2, -0.3),
      //   element: document.querySelector('.point--twitch'),
      //   details: document.querySelector('.screen--twitch'),
      //   visible: false,
      // },
    };
    /*
